...
BotonRegistrar.addEventListener("click",function(){
    ...
    fetch("http://tpazsa.orgfree.com/registro.php", {
...
botonIngresar.addEventListener("click",function(){
    ...
    fetch("http://tpazsa.orgfree.com/ingreso.php", {
        method: 'POST', //*GET, POST,PUT, DELETE, ETC.
        body: datosI
    })
    .then(function(response){
...
function cerrarBarra(){
 ...
 enviarM.addEventListener("click",function(){
    ...
    fetch("http://tpazsa.orgfree.com/guardarMensaje.php", {
        method: 'POST', //*GET, POST,PUT, DELETE, ETC.
        body: datos
    })
    .then (function(response){
...
fetch("http://tpazsa.orgfree.com/leerMensaje.php", {
